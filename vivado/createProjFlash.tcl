...
add_files -quiet $DIR_SRC/uart/debouncer.v
...
add_files -quiet $DIR_SRC/spi/spiMaster.sv
add_files -quiet $DIR_SRC/spi/spiFlash.sv
add_files -quiet $DIR_SRC/spi/spiFlashTest.sv
